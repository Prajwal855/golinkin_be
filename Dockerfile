...
# Install packages needed to build gems, including SQLite3 dependencies
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y build-essential git libsqlite3-dev pkg-config libsecp256k1-dev autoconf automake libtool && \
    rm -rf /var/lib/apt/lists /var/cache/apt/archives
